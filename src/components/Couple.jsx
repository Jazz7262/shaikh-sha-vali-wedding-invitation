            ...
            <div className="row">
                <div className="col-lg-5" data-aos="fade-up">
                    ...
                    <div className="info groom-info">
                        ...
                        <p className="mt-2">
                            Grand S/O Janaab{" "}
                            <strong>P. Khaja Hussain Sahab(Late),</strong>
                        </p>
                    </div>
                </div>
                <div
                ...
                <div className="col-lg-5" data-aos="fade-up">
                    ...
                    <div className="info">
                        <h3>Noor -e- A'ayin,</h3>
                        <p className="mt-2">D/O Janab Shaikh Hussain Sahab</p>
                        <p className="mt-2">
                            H.No.: 22/275, Opposite Roza -e- Chanda Hussaini
                            Masjid,
                            <br />
                            Karvanpet, Adoni - 518 301.
                        </p>
                    </div>
                </div>
            </div>
